            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        <td>Priority</td>
                        <td>
                            <ejs-dropdownlist :dataSource="priorityData" id="Priority" name="Priority" v-model='data.Priority' placeholder="Priority" cssClass="e-field"></ejs-dropdownlist>
                        </td>
                    </tr>
                    <tr>
                        <td>Summary</td>
...
export default {
    ...
    data: function () {
        return {
            ...
            statusData: ["Open", "InProgress", "Review", "Close"],
            assigneeData: ["Nancy Davloio","Andrew Fuller","Janet Leverling","Steven walker","Robert King","Margaret hamilt","Michael Suyama"],
